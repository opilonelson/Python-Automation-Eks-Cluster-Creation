...
response=eks_client.create_cluster(name='nellz-demo-cluster', roleArn='arn:aws:iam::987654321098:role/eks-cluster-role', resourcesVpcConfig={'subnetIds':['subnet-4567de56', 'subnet-6587jh42'], 'securityGroupIds':['sg-1234fe89'])
